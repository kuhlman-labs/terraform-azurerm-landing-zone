...
output "aks_kube_config_raw" {
  value       = module.aks_cluster.aks_kube_config_raw
...
output "aks_kube_config_client_key" {
  value       = module.aks_cluster.aks_kube_config_client_key
  description = "Base64 encoded private key used by clients to authenticate to the Kubernetes cluster."
}

output "aks_kube_config_client_certificate" {
  value       = module.aks_cluster.aks_kube_config_client_certificate
  description = "Base64 encoded public certificate used by clients to authenticate to the Kubernetes cluster."
}

output "aks_kube_config_cluster_ca_certificate" {
  value       = module.aks_cluster.aks_kube_config_cluster_ca_certificate
  description = "Base64 encoded public CA certificate used as the root of trust for the Kubernetes cluster."
}

output "aks_kube_config_host" {
  value       = module.aks_cluster.aks_kube_config_host
  description = "The Kubernetes cluster server host."
}

output "aks_kube_config_username" {
  value       = module.aks_cluster.aks_kube_config_username
  description = "A username used to authenticate to the Kubernetes cluster."
}

output "aks_kube_config_password" {
  value       = module.aks_cluster.aks_kube_config_password
