...
|------|-------------|------|---------|:--------:|
| action\_type | (Required) The Type of action to be performed when the lifetime trigger is triggerec. Possible values include AutoRenew and EmailContacts. Changing this forces a new resource to be created. | `string` | n/a | yes |
...
| exportable | (Required) Is this Certificate Exportable? Changing this forces a new resource to be created. | `bool` | `true` | no |
...
| key\_size | (Required) The size of the Key used in the Certificate. Possible values include 2048 and 4096. Changing this forces a new resource to be created. | `string` | n/a | yes |
...
| key\_usage | (Required) A list of uses associated with this Key. Possible values include cRLSign, dataEncipherment, decipherOnly, digitalSignature, encipherOnly, keyAgreement, keyCertSign, keyEncipherment and nonRepudiation and are case-sensitive. Changing this forces a new resource to be created. | `list` | n/a | yes |
...
| reuse | (Required) Is the key reusable? Changing this forces a new resource to be created. | `bool` | n/a | yes |
