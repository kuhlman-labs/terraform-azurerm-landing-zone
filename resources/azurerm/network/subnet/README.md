...
|------|-------------|------|---------|:-----:|
| address\_prefixes | (Optional) The address prefixes to use for the subnet. | `list` | n/a | yes |
...
| service\_endpoints | The list of Service endpoints to associate with the subnet. Possible values include: Microsoft.AzureActiveDirectory, Microsoft.AzureCosmosDB, Microsoft.EventHub, Microsoft.KeyVault, Microsoft.ServiceBus, Microsoft.Sql and Microsoft.Storage. | `list` | n/a | yes |
