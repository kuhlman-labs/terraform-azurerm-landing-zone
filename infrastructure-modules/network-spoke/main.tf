...
module "nsg-subnets-spoke-edge" {
  ...
  subnet_ids = "${matchkeys(module.vnet-subnets-spoke.subnet_ids,
...
module "vnet-peering" {
  ...
  hub_vnet_name               = "${data.terraform_remote_state.vnet-hub.shared_vnet_hub_name}"
  hub_vnet_rg                 = "${data.terraform_remote_state.vnet-hub.shared_vnet_hub_rg}"
  hub_vnet_id                 = "${data.terraform_remote_state.vnet-hub.shared_vnet_hub_id}"
